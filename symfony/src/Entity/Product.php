...
class Product implements \App\EntityInterface\ProductSystemInterface
{
    ...
    public function setProductEans(array $productEans): self
    {
    ...
    public function setUnitBox(?int $unitBox): self
    {
    ...
    public function setUnitPalet(?int $unitPalet): self
    {
    ...
    public function setMinSalesUnit(int $minSalesUnit): self
    {
